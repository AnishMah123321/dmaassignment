...
public class AddEditTaskActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    private void initViews() {
        ...
        Button button = (Button) findViewById(R.id.button);
        mEditText2 = findViewById(R.id.textView);
    ...
    private void populateUI(TaskEntry task) {
        ...
        mEditText2.setText(task.getDat());
    ...
    public void onSaveButtonClicked() {
        ...
        String dat = mEditText2.getText().toString();
        Date date = new Date();
        TaskEntry todo = new TaskEntry(description, priority,dat, date);
        if(mTaskId == DEFAULT_TASK_ID)
