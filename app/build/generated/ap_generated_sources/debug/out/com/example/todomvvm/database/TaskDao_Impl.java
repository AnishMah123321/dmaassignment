  ...
  public TaskDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTaskEntry = new EntityInsertionAdapter<TaskEntry>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `task` (`id`,`description`,`priority`,`updated_at`,`dat`) VALUES (nullif(?, 0),?,?,?,?)";
      }
    ...
    this.__updateAdapterOfTaskEntry = new EntityDeletionOrUpdateAdapter<TaskEntry>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR ABORT `task` SET `id` = ?,`description` = ?,`priority` = ?,`updated_at` = ?,`dat` = ? WHERE `id` = ?";
      }
      ...
      public List<TaskEntry> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new TaskEntry(_tmpId,_tmpDescription,_tmpPriority,_tmpDat,_tmpUpdatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public TaskEntry call() throws Exception {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            final String _tmpDat;
            _tmpDat = _cursor.getString(_cursorIndexOfDat);
            _result = new TaskEntry(_tmpId,_tmpDescription,_tmpPriority,_tmpDat,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
